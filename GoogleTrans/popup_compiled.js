...
(function() {
    var h, aa = aa || {}, m = this, n = function(a) {
        return void 0 !== a
    }, p = function(a) {
        return "string" == typeof a
    }, ba = function(a) {
        return "number" == typeof a
    }, q = function() {}, r = function(a) {
        a.Ua = void 0;
        a.H = function() {
    ...
    }, ea = "closure_uid_" + (1E9 * Math.random() >>> 0), fa = 0, ha = function(a, b, c) {
        ...
        Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? w = ha : w = ia;
    ...
    var ya = function(a, b, c, d) {
      ...
      , Ba = function(a, b, c) {
        p(a) || ya("Expected string but got %s: %s.", [ca(a), a], b, Array.prototype.slice.call(arguments, 2));
        return a
    }
      , Ca = function(a, b, c) {
    ...
    var gb = D("Opera"), E = D("Trident") || D("MSIE"), F = D("Edge"), hb = D("Gecko") && !(-1 != B.toLowerCase().indexOf("webkit") && !D("Edge")) && !(D("Trident") || D("MSIE")) && !D("Edge"), G = -1 != B.toLowerCase().indexOf("webkit") && !D("Edge"), H = D("Macintosh"), ib = D("Windows"), jb = D("Android"), kb = cb(), lb = D("iPad"), mb = D("iPod"), nb = function() {
        var a = m.document;
    ...
    ;
    var Rb = function(a, b) {
        a.D ? n(void 0) ? b.call(void 0) : b() : (a.K || (a.K = []),
        a.K.push(n(void 0) ? w(b, void 0) : b))
    };
    ...
    bc.prototype.add = function(a, b, c, d, e) {
        ...
        var g = cc(a, b, d, e);
        -1 < g ? (b = a[g],
        c || (b.Da = !1)) : (b = new $b(b,this.src,f,!!d,e),
        b.Da = c,
        a.push(b));
        return b
    }
    ...
    var ec = function(a, b, c, d, e) {
      ...
      , cc = function(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.removed && f.listener == b && f.capture == !!c && f.Ia == d)
                return e
        }
        return -1
    };
    var fc = "closure_lm_" + (1E6 * Math.random() | 0)
      ...
      , qc = function(a, b, c, d, e) {
        if (t(b))
            ...
            d = v(d) ? !!d.capture : !!d,
            c = kc(c),
            Yb(a) ? a.W(b, c, d, e) : a && (a = mc(a)) && (b = ec(a, b, c, d, e)) && rc(b)
    }
      , rc = function(a) {
        if (!ba(a) && a && !a.removed) {
            var b = a.src;
      ...
      , tc = function(a, b, c, d) {
        ...
        if (a = mc(a))
            if (b = a.a[b.toString()])
                ...
                a = 0; a < b.length; a++) {
                    var f = b[a];
                    f && f.capture == c && !f.removed && (f = sc(f, d),
                    e = e && !1 !== f)
                }
        return e
    }
    ...
    var vc = function(a) {
      ...
      , zc = function(a, b) {
        a.classList ? a.classList.remove(b) : wc(a, b) && (a.className = Ia(vc(a), function(a) {
            return a != b
        }).join(" "))
    }
      , Ac = function(a, b) {
    ...
    ;
    var Gc = function(a) {
        if (a instanceof Fc && a.constructor === Fc && a.b === Ec)
            return a.a;
    ...
    var Lc = function(a, b) {
        ...
        if ("undefined" != typeof c.HTMLScriptElement && "undefined" != typeof c.Location && "undefined" != typeof c.Element) {
            ...
            A(c, "Argument is not a %s (or a non-Element, non-Location mock); got: %s", "HTMLScriptElement", d)
        }
        a.src = Gc(b)
    };
    var Oc = function(a) {
    ...
    M.prototype.remove = function(a) {
        return fd(this.b, a) ? (delete this.b[a],
        this.c--,
        this.h++,
        this.a.length > 2 * this.c && ed(this),
        !0) : !1
    }
    ;
    var ed = function(a) {
      ...
      , hd = function(a, b, c) {
        if (a.forEach && "function" == typeof a.forEach)
            ...
            if (a.V && "function" == typeof a.V)
                var d = a.V();
            else if (a.M && "function" == typeof a.M)
                d = void 0;
            else if (da(a) || p(a)) {
                d = [];
    ...
    kd.prototype.remove = function(a) {
        ld(this);
        a = md(this, a);
        return fd(this.a.b, a) ? (this.c = null,
        this.b = Aa(this.b) - this.a.get(a).length,
        this.a.remove(a)) : !1
    }
    ;
    ...
    h.M = function(a) {
        ...
        var b = [];
        if (p(a))
            nd(this, a) && (b = Qa(b, this.a.get(md(this, a))));
        else {
            a = this.a.M();
            for (var c = 0; c < a.length; c++)
                b = Qa(b, a[c])
    ...
    var Fd = function(a, b, c, d, e, f) {
      ...
      , Dd = function(a) {
        if (48 <= a && 57 >= a || 96 <= a && 106 >= a || 65 <= a && 90 >= a || (G || F) && 0 == a)
            return !0;
        switch (a) {
        case 32:
        case 43:
    ...
    var O = function(a, b) {
        ...
        if (c) {
            var d = [];
            for (var e = 1; c; c = c.Aa)
                d.push(c),
                A(1E3 > ++e, "infinite loop")
        }
        a = a.sb;
        c = b.type || b;
        p(b) ? b = new Tb(b,a) : b instanceof Tb ? b.target = b.target || a : (e = b,
        b = new Tb(c,a),
        Za(b, e));
        e = !0;
        if (d)
    ...
    h.zb = function(a) {
        if (G || F)
            if (17 == this.J && !a.ctrlKey || 18 == this.J && !a.altKey || H && 91 == this.J && !a.metaKey)
                this.aa = this.J = -1;
        -1 == this.J && (a.ctrlKey && 17 != a.keyCode ? this.J = 17 : a.altKey && 18 != a.keyCode ? this.J = 18 : a.metaKey && 91 != a.keyCode && (this.J = 91));
        Md && !Fd(a.keyCode, this.J, a.shiftKey, a.ctrlKey, a.altKey, a.metaKey) ? this.handleEvent(a) : (this.aa = Ed(a.keyCode),
        Nd && (this.Oa = a.altKey))
    }
    ;
    h.Bb = function(a) {
    ...
    h.handleEvent = function(a) {
        var b = a.b
          , c = b.altKey;
        if (E && "keypress" == a.type)
            var d = this.aa;
        else if ((G || F) && "keypress" == a.type)
            d = this.aa;
        else if (gb && !G)
            d = this.aa;
        else {
    ...
    h.W = function(a, b, c, d, e) {
        if (t(b))
            ...
            c = kc(c),
            d = !!d,
            b = Yb(a) ? ec(a.h, String(b), c, d, e) : a ? (a = mc(a)) ? ec(a, b, c, d, e) : null : null,
            b && (rc(b),
            delete this.a[b.key]);
        return this
    }
    ...
    Q.prototype.R = function(a, b) {
        ...
        var c = 0
          ...
          , l = Ra(vc(b));
        Ha(l, function(a) {
            f || a != d ? g || a != e ? c |= je(this, a) : g = !0 : (f = !0,
            e == d && (g = !0));
            1 == je(this, a) && (Da(b),
            Zc(b) && $c(b, !1))
        }, this);
    ...
    var ke = function(a, b) {
        if (a = a.Ea()) {
            ...
            a != c && (a ? (A(Xa(Rd, a), "No such ARIA role " + a),
    ...
    h.Sa = function(a, b) {
        ...
        if (Cd) {
            if (c = c ? "none" : "",
            a.style && (a.style[Cd] = c),
            b) {
                a = 0;
                for (var d; d = b[a]; a++)
                    d.style && (d.style[Cd] = c)
            }
        } else if (E || gb)
            if (c = c ? "on" : "",
    ...
    var re = function(a) {
      ...
      , se = function(a, b) {
        b && (a.O ? Oa(a.O, b) || a.O.push(b) : a.O = [b],
        he(a, b, !0))
    };
    ...
    R.prototype.U = function() {
        ...
        this.b.nb(this);
        this.F & -2 && (this.Ha && qe(this, !0),
        this.F & 32 && (a = this.o())) && (b = this.G || (this.G = new Jd),
        b.attach(a),
        $d(this).listen(b, "key", this.Ab).listen(a, "focus", this.yb).listen(a, "blur", this.hb))
    }
    ;
    var qe = function(a, b) {
        var c = $d(a)
          , d = a.o();
        b ? (c.listen(d, "mouseover", a.lb).listen(d, "mousedown", a.ya).listen(d, "mouseup", a.za).listen(d, "mouseout", a.kb),
        a.Fa != q && c.listen(d, "contextmenu", a.Fa),
        E && (I(9) || c.listen(d, "dblclick", a.jb),
        a.T || (a.T = new te(a),
        Rb(a, x(Sb, a.T))))) : (c.W(d, "mouseover", a.lb).W(d, "mousedown", a.ya).W(d, "mouseup", a.za).W(d, "mouseout", a.kb),
        a.Fa != q && c.W(d, "contextmenu", a.Fa),
        E && (I(9) || c.W(d, "dblclick", a.jb),
        Sb(a.T),
        a.T = null))
    };
    ...
    R.prototype.setEnabled = function(a) {
        var b = this.i;
        b && "function" == typeof b.a && !b.a() || !ve(this, 1, !a) || (a || (we(this, !1),
        xe(this, !1)),
        this.ea && this.b.La(this, a),
        ye(this, 1, !a, !0))
    }
    ;
    var xe = function(a, b) {
    ...
    var ye = function(a, b, c, d) {
        d || 1 != b ? a.F & b && c != !!(a.C & b) && (a.b.Ta(a, b, c),
        a.C = c ? a.C | b : a.C & ~b) : a.setEnabled(!c)
    }
      , ze = function(a) {
        if (a.P && a.C & 32)
            throw Error("Component already rendered");
    ...
    ;
    h.kb = function(a) {
        a.relatedTarget && Vc(this.o(), a.relatedTarget) || !O(this, "leave") || (S(this, 4) && we(this, !1),
        S(this, 2) && xe(this, !1))
    }
    ;
    h.Fa = q;
    h.ya = function(a) {
        this.a() && (S(this, 2) && xe(this, !0),
        !Wb(a) || G && H && a.ctrlKey || (S(this, 4) && we(this, !0),
        this.b && this.b.fb(this) && this.o().focus()));
        !Wb(a) || G && H && a.ctrlKey || a.h()
    }
    ;
    h.za = function(a) {
        this.a() && (S(this, 2) && xe(this, !0),
        this.C & 4 && this.pa(a) && S(this, 4) && we(this, !1))
    }
    ;
    h.jb = function(a) {
        this.a() && this.pa(a)
    ...
    ;
    h.Ab = function(a) {
        return this.ea && this.a() && this.Ga(a) ? (a.h(),
        a.i(),
        !0) : !1
    }
    ;
    ...
    if (!u(Q))
        throw Error("Invalid renderer class " + Q);
    var Ae = R[ea] || (R[ea] = ++fa);
    pe[Ae] = Q;
    ...
    var Fe = function(a) {
      ...
      , He = function(a) {
        if (null != a && a.ga === od)
            return A(a.constructor === td),
            a;
        if (a instanceof Jc) {
            var b = Ge;
            if (a instanceof Jc && a.constructor === Jc && a.h === Ic)
                var c = a.a;
            else
                za("expected object of type SafeHtml, got '" + a + "' of type " + ca(a)),
                c = "type_error:SafeHtml";
            a = b(c, a.c())
        } else
            a = Ge(ua(String(String(a))), Fe(a));
        return a
    }
      , Ge = function(a) {
        function b(a) {
    ...
    var Me = function(a) {
        return null != a && a.ga === od ? (A(a.constructor === td),
        String(String(a.$()).replace(Ie, "").replace(Je, "&lt;")).replace(Ke, Le)) : ua(String(a))
    }
      , Ne = {
        "\x00": "&#0;",
        "\t": "&#9;",
    ...
    var Pe = function(a) {
        ...
        f += (1 == e.width ? " jfk-button-narrow" : "") + (e.checked ? " jfk-button-checked" : "") + (e.vb ? " " + e.vb : "") + (e.disabled ? " jfk-button-disabled" : "");
        ...
        null != a && a.ga === pd ? (A(a.constructor === ud),
        a = a.$().replace(/([^"'\s])$/, "$1 ")) : (a = String(a),
        Oe.test(a) || (za("Bad value `%s` for |filterHtmlAttributes", [a]),
        a = "zSoyz")),
        a = " " + a) : a = "";
    ...
    var cf = function(a, b) {
        ...
        if (-1 != String(m.Promise).indexOf("[native code]")) {
            ...
            Ze = function() {
                var a = df;
                !u(m.setImmediate) || m.Window && m.Window.prototype && !D("Edge") && m.Window.prototype.setImmediate == m.setImmediate ? (Ue || (Ue = Ve()),
                Ue(a)) : m.setImmediate(a)
            }
    }, af = !1, bf = new We, df = function() {
        ...
        if (0 == a.a)
            if (a.c) {
                ...
                if (c.b) {
                    ...
                    !(e && 1 < d))); g = g.next)
                        e || (f = g);
                    e && (0 == c.a && 1 == d ? of(c, b) : (f ? (d = f,
                    A(c.b),
                    A(null != d),
                    d.next == c.h && (c.h = d),
                    d.next = d.next.next) : pf(c),
                    qf(c, e, 3, b)))
                }
                a.c = null
            } else
    ...
    (function() {
        ...
        return H ? (a = /10[_.][0-9_.]+/,
        (a = a.exec(B)) ? a[0].replace(/_/g, ".") : "10") : jb ? (a = /Android\s+([^\);]+)(\)|;)/,
        (a = a.exec(B)) ? a[1] : "") : kb || lb || mb ? (a = /(?:iPhone|CPU)\s+OS\s+(\S+)/,
    ...
    var yf = function(a) {
      ...
      , zf = function() {
        ...
        if (E || F || gb)
            return sb;
        if (zb)
            return cb() || D("iPad") || D("iPod") ? yf(/CriOS\/([0-9.]+)/) : yf(/Chrome\/([0-9.]+)/);
        if (Ab && !(cb() || D("iPad") || D("iPod")))
    ...
    T.prototype.setEnabled = function(a) {
        this.a() != a && (T.l.setEnabled.call(this, a),
        Cf(this))
    }
    ;
    ...
    var Df = function(a, b) {
        a.o() && (a = a.o(),
        b ? xc(a, "jfk-button-clear-outline") : zc(a, "jfk-button-clear-outline"))
    }
      , Cf = function(a) {
        a.o() && Ef(a.b, a)
    }
    ...
    h.na = function(a) {
        ...
        c.innerHTML = d;
        1 == c.childNodes.length && (d = c.firstChild,
        1 == d.nodeType && (c = d));
        b.xb(c, a.$());
        this.R(a, c);
        return c
    ...
    var Lf = function(a, b, c) {
        var d = c.toLowerCase();
        d in Jf && Kf[Jf[d.toLowerCase()]] >= b.length ? (a.O && Pa(a.O, "no-audio") && (0 == a.O.length && (a.O = null),
        he(a, "no-audio", !1)),
        a.Ba = b,
        a.sa = c) : se(a, "no-audio")
    }
      , If = function(a, b) {
...
*/
    ...
    Nf.prototype.cancel = function(a) {
        if (this.a)
            this.c instanceof Nf && this.c.cancel();
        else {
            if (this.b) {
                var b = this.b;
                delete this.b;
        ...
        for (var d = c = !1; a.i.length && !a.m; ) {
            ...
            if (f = a.h ? g : f)
                try {
                    ...
                    n(k) && (a.h = a.h && (k == b || a.isError(k)),
                    a.c = b = k);
                    if (ff(b) || "function" === typeof m.Promise && b instanceof m.Promise)
                        d = !0,
                        a.m = !0
                } catch (l) {
                    b = l,
    ...
    var cg = function(a, b) {
        ...
        e.onload = e.onreadystatechange = function() {
            e.readyState && "loaded" != e.readyState && "complete" != e.readyState || ($f(e, c.wb || !1, k),
            Tf(g),
            Uf(null),
            Qf(g, !0, null))
        }
        ...
        e.onerror = function() {
            $f(e, !0, k);
            Of(g, new ag(0,"Error while loading script " + d))
        }
        ;
        f = c.attributes || {};
        Za(f, {
    ...
    dg.prototype.send = function(a, b, c, d) {
        ...
        var f = /\?/.test(e) ? "&" : "?";
        for (l in a)
            for (var g = t(a[l]) ? a[l] : [a[l]], k = 0; k < g.length; k++)
    ...
    jg.prototype.D = function(a) {
        ...
        if (this.m) {
            ...
            (864E5 < Math.abs(b - c) || d != a) && (new dg("https://translate.googleapis.com/translate_a/l","cb")).send({
                client: "gtx",
                hl: d
            }, w(this.u, this, d))
        }
    ...
    var vd = function(a) {
        ...
        if (a.query)
            if (a.qb) {
                ...
                b += '</select></div><div class="gtx-source-audio"><div class="jfk-button-img"></div></div><div class="gtx-body">' + He(a.query) + '</div><br><div class="gtx-language">' + He(a.Fb) + '</div><div class="gtx-target-audio"><div class="jfk-button-img"></div></div><div class="gtx-body">' + He(a.qb) + "</div>";
                if (a.ab) {
                ...
                b += "No translation results for <b>" + He(a.query) + "</b>.";
        return b
    };
    ...
    Kg.prototype.send = function(a, b, c, d) {
        ...
        try {
            Tg(this),
            0 < this.s && (this.L = Ug(this.a),
            Dg(this.N, Rg(this, "Will abort after " + this.s + "ms if incomplete, xhr2 " + this.L)),
            this.L ? (this.a.timeout = this.s,
            this.a.ontimeout = w(this.ha, this)) : this.G = xf(this.ha, this.s, this)),
            Dg(this.N, Rg(this, "Sending request")),
            this.u = !0,
            this.a.send(a),
            this.u = !1
        } catch (f) {
            Dg(this.N, Rg(this, "Send error: " + f.message)),
            Sg(this, f)
        }
    }
    ;
    ...
    Kg.prototype.ha = function() {
        "undefined" != typeof aa && this.a && (this.m = "Timed out after " + this.s + "ms, aborting",
        this.i = 8,
        Dg(this.N, Rg(this, this.m)),
        O(this, "timeout"),
        this.abort(8))
    }
    ;
    ...
    Kg.prototype.abort = function(a) {
        this.a && this.b && (Dg(this.N, Rg(this, "Aborting")),
        this.b = !1,
        this.c = !0,
        this.a.abort(),
        this.c = !1,
    ...
    var Xg = function(a) {
        if (a.b && "undefined" != typeof aa)
            if (a.T[1] && 4 == Yg(a) && 2 == Zg(a))
                Dg(a.N, Rg(a, "Local request error detected and ignored"));
            else if (a.u && 4 == Yg(a))
                xf(a.ra, 0, a);
                ...
                try {
                    if ($g(a))
                        ...
                        try {
                            ...
                            Dg(a.N, "Can not get status: " + c.message),
                            b = ""
                        }
                        a.m = b + " [" + Zg(a) + "]";
                        Vg(a)
    ...
    var ai = function(a, b, c, d) {
        if ("" != a) {
            ...
            l.remove("dt");
            0 < e.length && (l.c = null,
            l.a.set(md(l, "dt"), Ra(e)),
            l.b = Aa(l.b) + e.length);
            l.set("dj", "1");
            c && l.h(c);
            C.set("q", g);
            Xh(a, k, l, C, w(a.h, a, b, void 0))
        }
    };
    $h.prototype.a = function(a, b, c, d) {
        if (null != d) {
            for (var e = d.src, f = lg(), g = [], k = [], l = d.sentences, C = 0; C < l.length; C++)
                g.push(l[C].orig),
                k.push(l[C].trans);
            g = g.join("");
            k = k.join("");
            ...
            c = new T("",void 0,4),
            ae(c, L("new-translation")),
            Bd(L("new-translation"), !0),
            c = L("translate-page"),
            Wc(a, Ff("MSG_OPEN_IN_TRANSLATE")),
            c.className = "gtx-a",
            c.setAttribute("style", "margin-left: 0px;"),
            Bd(a, !0)) : (a = document.createElement("a"),
            a.id = "off",
            a.className = "gtx-a",
            a.setAttribute("target", "_blank"),
            Wc(a, Ff("MSG_FOOTER_OPTIONS").toUpperCase()),
            ...
            Wc(L("translation"), Ff("MSG_TRANSLATION_ERROR"))
    }
    ;
    ...
    var ci = function(a, b, c) {
        if (b) {
            ...
            Sd(b, "checked", null == c ? "mixed" : 1 == c ? "true" : "false"))
        }
    };
    ...
    h.setEnabled = function(a) {
        ...
        if (a = this.o())
            a.tabIndex = this.a() ? 0 : -1
    }
    ;
    h.ib = function(a) {
        a.i();
        var b = this.m ? "uncheck" : "check";
        this.a() && !a.target.href && O(this, b) && (a.h(),
        this.Wa(this.m ? !1 : !0),
        O(this, "change"))
    }
    ;
    h.Ga = function(a) {
        32 == a.keyCode && (this.pa(a),
        this.ib(a));
        return !1
    }
    ;
    ...
    var ii = function() {
      ...
      , oi = function(a, b) {
        "" != a.trim() && (Bd(L("search-bar"), !1),
        ai(a, w(gi.a, gi, !0, a, L("translation")), b))
    };
}
)();
