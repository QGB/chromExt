function doc_keyUp(e) {
    // qgb content script     this would test for whichever key is 40 and the ctrl key at the same time
	// console.log(e)
    if (e.altKey && e.keyCode == 50) {// KEY_2
		// alert(2333333)
		for(i of document.querySelectorAll('iframe')){
			if(i.className=="goog-te-banner-frame skiptranslate"){
				// alert(i.contentDocument.innerText)//undefined
				i.contentDocument.querySelector ('a.goog-close-link').click()
				break
			}
		}
...
(function() {
    var h, aa = aa || {}, n = this, p = function(a) {
    ...
    }, da = "closure_uid_" + (1E9 * Math.random() >>> 0), ea = 0, fa = function(a, b, c) {
        ...
        Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? z = fa : z = ha;
        ...
        for (var d = Math.max(a.length, b.length), e = 0; 0 == c && e < d; e++) {
            ...
            do {
                ...
                if (0 == f[0].length && 0 == g[0].length)
                    break;
                c = va(0 == f[1].length ? 0 : parseInt(f[1], 10), 0 == g[1].length ? 0 : parseInt(g[1], 10)) || va(0 == f[2].length, 0 == g[2].length) || va(f[2], g[2]);
                f = f[3];
                g = g[3]
            } while (0 == c)
        }
    ...
    var Aa = function(a, b, c, d) {
      ...
      , Da = function(a, b, c) {
        q(a) || Aa("Expected string but got %s: %s.", [u(a), a], b, Array.prototype.slice.call(arguments, 2));
        return a
    }
      , Ea = function(a, b, c) {
      ...
      , Ia = function(a, b, c, d) {
        a instanceof b || Aa("Expected instanceof %s but got %s.", [Ha(b), Ha(a)], c, Array.prototype.slice.call(arguments, 3));
        return a
    }
      , Ha = function(a) {
    ...
    var nb = E("Opera"), F = E("Trident") || E("MSIE"), ob = E("Edge"), pb = ob || F, G = E("Gecko") && !(-1 != Va.toLowerCase().indexOf("webkit") && !E("Edge")) && !(E("Trident") || E("MSIE")) && !E("Edge"), H = -1 != Va.toLowerCase().indexOf("webkit") && !E("Edge"), qb = H && E("Mobile"), rb = E("Macintosh"), sb = E("Windows"), tb = E("Android"), ub = hb(), vb = E("iPad"), wb = E("iPod"), xb = ib(), yb = function() {
        var a = n.document;
    ...
    ;
    var ec = function(a, b) {
        a.C ? p(void 0) ? b.call(void 0) : b() : (a.G || (a.G = []),
        a.G.push(p(void 0) ? z(b, void 0) : b))
    };
    ...
    var ic = function(a, b) {
        ...
        if (a) {
            ...
            (b = a.relatedTarget) ? G && (kb(b, "nodeName") || (b = null)) : "mouseover" == c ? b = a.fromElement : "mouseout" == c && (b = a.toElement);
    ...
    qc.prototype.add = function(a, b, c, d, e) {
        ...
        var g = rc(a, b, d, e);
        -1 < g ? (b = a[g],
        c || (b.Ka = !1)) : (b = new oc(b,this.src,f,!!d,e),
        b.Ka = c,
        a.push(b));
        return b
    }
    ...
    var tc = "closure_lm_" + (1E6 * Math.random() | 0)
      ...
      , Ec = function(a, b, c, d, e) {
        if (w(b))
            ...
            d = y(d) ? !!d.capture : !!d,
            c = yc(c),
            mc(a) ? a.S(b, c, d, e) : a && (a = Ac(a)) && (b = a.Ca(b, c, d, e)) && Fc(b)
    }
      , Fc = function(a) {
        if (r(a) || !a || a.removed)
            return !1;
      ...
      , Ic = function(a, b, c, d) {
        ...
        if (a = Ac(a))
            if (b = a.a[b.toString()])
                ...
                a = 0; a < b.length; a++) {
                    var f = b[a];
                    f && f.capture == c && !f.removed && (f = Hc(f, d),
                    e = e && !1 !== f)
                }
        return e
    }
    ...
    var Kc = function(a) {
      ...
      , Oc = function(a, b) {
        a.classList ? a.classList.remove(b) : Lc(a, b) && (a.className = La(Kc(a), function(a) {
            return a != b
        }).join(" "))
    }
      , Pc = function(a, b) {
    ...
    ;
    var Wc = function(a) {
        if (a instanceof Vc && a.constructor === Vc && a.b === Uc)
            return a.a;
    ...
    ;
    var $c = function(a) {
        if (a instanceof Zc && a.constructor === Zc && a.b === Yc)
            return a.a;
    ...
    ;
    var dd = function(a) {
        if (a instanceof cd && a.constructor === cd && a.b === bd)
            return a.a;
    ...
    var jd = function(a) {
      ...
      , pd = function(a) {
        if (a instanceof cd)
            return 'url("' + dd(a).replace(/</g, "%3c").replace(/[\\"]/g, "\\$&") + '")';
        if (a instanceof Vc)
            a = Wc(a);
        else {
            a = String(a);
            ...
            if (nd.test(b)) {
                ...
                b && c ? a = od(a) : (Ba("String value requires balanced quotes, got: " + a),
                a = "zClosurez")
            } else
                Ba("String value allows only [-,.\"'%_!# a-zA-Z0-9] and simple functions, got: " + a),
                a = "zClosurez"
        }
    ...
    ;
    var sd = function(a) {
        if (a instanceof rd && a.constructor === rd && a.c === qd)
            return a.a;
    ...
    var Ad = {
      ...
      , Cd = function(a, b) {
        ...
        if ("undefined" != typeof c.HTMLScriptElement && "undefined" != typeof c.Location && "undefined" != typeof c.Element) {
            ...
            var d = y(a) ? a.constructor.displayName || a.constructor.name || Object.prototype.toString.call(a) : void 0 === a ? "undefined" : null === a ? "null" : typeof a;
    ...
    de.prototype.remove = function(a) {
        return ge(this.b, a) ? (delete this.b[a],
        this.c--,
        this.h++,
      ...
      , ie = function(a, b, c) {
        if (a.forEach && "function" == typeof a.forEach)
            ...
            if (a.fa && "function" == typeof a.fa)
                var d = a.fa();
            else if (a.O && "function" == typeof a.O)
                d = void 0;
            else if (ca(a) || q(a)) {
                d = [];
    ...
    le.prototype.remove = function(a) {
        me(this);
        a = ne(this, a);
        return ge(this.a.b, a) ? (this.c = null,
    ...
    h.O = function(a) {
        ...
        var b = [];
        if (q(a))
            oe(this, a) && (b = Ta(b, this.a.get(ne(this, a))));
        else {
            a = this.a.O();
            for (var c = 0; c < a.length; c++)
                b = Ta(b, a[c])
    ...
    h.translate = function(a, b) {
        a instanceof L ? (this.left += a.x,
        this.right += a.x,
        this.top += a.y,
        this.bottom += a.y) : (Ca(a),
        this.left += a,
        this.right += a,
        r(b) && (this.top += b,
        this.bottom += b));
    ...
    var De = function(a, b, c) {
      ...
      , Ce = function(a, b) {
        ...
        if (!c) {
            var d = xa(b);
            c = d;
            void 0 === a.style[d] && (d = (H ? "Webkit" : G ? "Moz" : F ? "ms" : nb ? "O" : null) + ya(d),
      ...
      , Ge = function(a, b) {
        return Fe(a, b) || (a.currentStyle ? a.currentStyle[b] : null) || a.style && a.style[b]
    }
      , Ie = function(a, b, c) {
        if (b instanceof L) {
            var d = b.x;
      ...
      , Me = function(a) {
        for (var b = new Ae(0,Infinity,Infinity,0), c = Hd(a), d = c.a.body, e = c.a.documentElement, f = Md(c.a); a = Ke(a); )
            if (!(F && 0 == a.clientWidth || H && 0 == a.clientHeight && a == d) && a != d && a != e && "visible" != Ge(a, "overflow")) {
                var g = Le(a)
      ...
      , Qe = function(a) {
        var b = a.offsetWidth
          , c = a.offsetHeight
          , d = H && !b && !c;
        return p(b) && !d || !a.getBoundingClientRect ? new Ed(b,c) : (a = Je(a),
    ...
    var bf = function(a, b, c, d, e, f) {
      ...
      , $e = function(a) {
        if (48 <= a && 57 >= a || 96 <= a && 106 >= a || 65 <= a && 90 >= a || (H || ob) && 0 == a)
            return !0;
        switch (a) {
        case 32:
        case 43:
    ...
    h.Wb = function(a) {
        if (H || ob)
            if (17 == this.M && !a.ctrlKey || 18 == this.M && !a.altKey || rb && 91 == this.M && !a.metaKey)
                this.ma = this.M = -1;
        -1 == this.M && (a.ctrlKey && 17 != a.keyCode ? this.M = 17 : a.altKey && 18 != a.keyCode ? this.M = 18 : a.metaKey && 91 != a.keyCode && (this.M = 91));
        jf && !bf(a.keyCode, this.M, a.shiftKey, a.ctrlKey, a.altKey, a.metaKey) ? this.handleEvent(a) : (this.ma = af(a.keyCode),
        kf && (this.Sa = a.altKey))
    }
    ;
    h.Yb = function(a) {
    ...
    h.handleEvent = function(a) {
        ...
        if (F && "keypress" == a.type) {
            ...
            (H || ob) && "keypress" == a.type ? (d = this.ma,
            e = 0 <= b.charCode && 63232 > b.charCode && $e(d) ? b.charCode : 0) : nb && !H ? (d = this.ma,
            e = $e(d) ? b.keyCode : 0) : (d = b.keyCode || this.ma,
            e = b.charCode || 0,
            kf && (c = this.Sa),
            rb && 63 == e && 224 == d && (d = 191));
        var f = d = af(d);
    ...
    qf.prototype.S = function(a, b, c, d, e) {
        if (w(b))
            ...
            c = yc(c),
            d = !!d,
            b = mc(a) ? a.Ca(b, c, d, e) : a ? (a = Ac(a)) ? a.Ca(b, c, d, e) : null : null,
            b && (Fc(b),
            delete this.a[b.key]);
        return this
    }
    ...
    Cf.prototype.ia = function(a, b) {
        ...
        var c = 0
          ...
          , l = Ua(Kc(b));
        Ka(l, function(a) {
            f || a != d ? g || a != e ? c |= Jf(this, a) : g = !0 : (f = !0,
            e == d && (g = !0));
            1 == Jf(this, a) && (Ga(b),
            Yd(b) && Zd(b, !1))
        }, this);
    ...
    var Kf = function(a, b) {
        if (a = a.Za()) {
            ...
            a != c && (a ? (D(bb(of, a), "No such ARIA role " + a),
            b.setAttribute("role", a)) : b.removeAttribute("role"))
        }
    };
    h = Cf.prototype;
    h.$a = function(a, b) {
        ...
        if (Ve) {
            if (c = c ? "none" : "",
            a.style && (a.style[Ve] = c),
            b) {
                a = 0;
                for (var d; d = b[a]; a++)
                    d.style && (d.style[Ve] = c)
            }
        } else if (F || nb)
            if (c = c ? "on" : "",
    ...
    var Rf = function(a) {
      ...
      , Sf = function(a, b) {
        b && (a.U ? Ra(a.U, b) || a.U.push(b) : a.U = [b],
        Hf(a, b, !0))
    };
    h = O.prototype;
    h.Xa = function() {
    ...
    h.ba = function() {
        ...
        this.c.Gb(this);
        this.H & -2 && (this.cb && Qf(this, !0),
        this.H & 32 && (a = this.l())) && (b = this.j || (this.j = new ff),
        b.attach(a),
        yf(this).listen(b, "key", this.Xb).listen(a, "focus", this.Vb).listen(a, "blur", this.Bb))
    }
    ;
    var Qf = function(a, b) {
        var c = yf(a)
          , d = a.l();
        b ? (c.listen(d, "mouseover", a.Eb).listen(d, "mousedown", a.Fa).listen(d, "mouseup", a.Ga).listen(d, "mouseout", a.Db),
        a.Ma != t && c.listen(d, "contextmenu", a.Ma),
        F && (I(9) || c.listen(d, "dblclick", a.Cb),
        a.D || (a.D = new Tf(a),
        ec(a, A(fc, a.D))))) : (c.S(d, "mouseover", a.Eb).S(d, "mousedown", a.Fa).S(d, "mouseup", a.Ga).S(d, "mouseout", a.Db),
        a.Ma != t && c.S(d, "contextmenu", a.Ma),
        F && (I(9) || c.S(d, "dblclick", a.Cb),
        fc(a.D),
        a.D = null))
    };
    ...
    O.prototype.setEnabled = function(a) {
        var b = this.i;
        b && "function" == typeof b.b && !b.b() || !Vf(this, 1, !a) || (a || (Wf(this, !1),
        Xf(this, !1)),
    ...
    var Yf = function(a, b, c, d) {
        d || 1 != b ? a.H & b && c != !!(a.w & b) && (a.c.ab(a, b, c),
        a.w = c ? a.w | b : a.w & ~b) : a.setEnabled(!c)
    }
      , Zf = function(a) {
        if (a.L && a.w & 32)
            throw Error("Component already rendered");
    ...
    ;
    h.Db = function(a) {
        a.relatedTarget && Ud(this.l(), a.relatedTarget) || !this.dispatchEvent("leave") || (P(this, 4) && Wf(this, !1),
        P(this, 2) && Xf(this, !1))
    }
    ;
    h.Ma = t;
    h.Fa = function(a) {
        this.b() && (P(this, 2) && Xf(this, !0),
        kc(a) && (P(this, 4) && Wf(this, !0),
    ...
    h.Ha = function(a) {
        ...
        P(this, 64) && (b = !(this.w & 64),
        Vf(this, 64, b) && Yf(this, 64, b));
    ...
    ;
    h.Xb = function(a) {
        return this.oa && this.b() && this.bb(a) ? (a.preventDefault(),
        a.stopPropagation(),
        !0) : !1
    }
    ;
    ...
    if (!x(Cf))
        throw Error("Invalid renderer class " + Cf);
    var $f = O[da] || (O[da] = ++ea);
    Pf[$f] = Cf;
    ...
    var eg = function(a) {
      ...
      , gg = function(a) {
        return null != a && a.aa === pe ? (D(a.constructor === ue),
        a) : a instanceof rd ? fg(sd(a), a.ua()) : fg(ua(String(String(a))), eg(a))
    }
      , fg = function(a) {
        function b(a) {
            this.content = a
    ...
    var R = function(a) {
        return null != a && a.aa === pe ? (D(a.constructor === ue),
        String(String(a.ha()).replace(hg, "").replace(ig, "&lt;")).replace(jg, kg)) : ua(String(a))
    }
      , lg = {
        "\x00": "&#0;",
        "\t": "&#9;",
    ...
    var ng = function(a) {
        ...
        f += (1 == e.width ? " jfk-button-narrow" : "") + (e.checked ? " jfk-button-checked" : "") + (e.Sb ? " " + e.Sb : "") + (e.disabled ? " jfk-button-disabled" : "");
        ...
        null != a && a.aa === qe ? (D(a.constructor === ve),
        a = a.ha().replace(/([^"'\s])$/, "$1 ")) : (a = String(a),
        mg.test(a) || (Ba("Bad value `%s` for |filterHtmlAttributes", [a]),
        a = "zSoyz")),
        a = " " + a) : a = "";
    ...
    var Ag = function(a, b) {
        ...
        if (-1 != String(n.Promise).indexOf("[native code]")) {
            ...
            wg = function() {
                var a = Bg;
                !x(n.setImmediate) || n.Window && n.Window.prototype && !E("Edge") && n.Window.prototype.setImmediate == n.setImmediate ? (rg || (rg = sg()),
                rg(a)) : n.setImmediate(a)
            }
    }, yg = !1, zg = new tg, Bg = function() {
    ...
    var Lg = function(a, b) {
        if (0 == a.a)
            if (a.c) {
                var c = a.c;
                if (c.b) {
                    for (var d = 0, e = null, f = null, g = c.b; g && (g.i || (d++,
                    g.a == a && (e = g),
                    !(e && 1 < d))); g = g.next)
                        e || (f = g);
                    e && (0 == c.a && 1 == d ? Lg(c, b) : (f ? (d = f,
                    D(c.b),
                    D(null != d),
                    d.next == c.h && (c.h = d),
                    d.next = d.next.next) : Mg(c),
                    Ng(c, e, 3, b)))
                }
                a.c = null
            } else
    ...
    var Wg = function() {
        ...
        return rb ? (a = /10[_.][0-9_.]+/,
        (a = a.exec(Va)) ? a[0].replace(/_/g, ".") : "10") : tb ? (a = /Android\s+([^\);]+)(\)|;)/,
        (a = a.exec(Va)) ? a[1] : "") : ub || vb || wb ? (a = /(?:iPhone|CPU)\s+OS\s+(\S+)/,
    ...
    var Xg = function(a) {
      ...
      , Yg = function() {
        if (Ib)
            return Xg(/Firefox\/([0-9.]+)/);
        if (F || ob || nb)
            return Db;
        if (Mb)
            return ib() ? Xg(/CriOS\/([0-9.]+)/) : Xg(/Chrome\/([0-9.]+)/);
        if (Nb && !ib())
            return Xg(/Version\/([0-9.]+)/);
        if (Jb || Kb) {
    ...
    h.wb = function(a, b, c) {
        ...
        if (this.b) {
            ...
            if (l = Me(f))
                ...
                ch(a) ? f.top < l.top && !(k & 1) ? g -= l.top - f.top : f.bottom > l.bottom && k & 1 && (g -= f.bottom - l.bottom) : f.left < l.left && !(k & 4) ? g -= l.left - f.left : f.right > l.right && k & 4 && (g -= f.right - l.right);
            ...
            if (c || 0 != k)
                k & 4 ? l.x -= f.width + (c ? c.right : 0) : k & 2 ? l.x -= f.width / 2 : c && (l.x += c.left),
            ...
            e == f || e && f && e.width == f.width && e.height == f.height || (c = f,
            e = Gd(g),
            k = Pd(Hd(e).a),
            !F || I("10") || k && I("8") ? (g = g.style,
            G ? g.MozBoxSizing = "border-box" : H ? g.WebkitBoxSizing = "border-box" : g.boxSizing = "border-box",
            g.width = Math.max(c.width, 0) + "px",
            g.height = Math.max(c.height, 0) + "px") : (e = g.style,
            k ? (F ? (k = Xe(g, "paddingLeft"),
            l = Xe(g, "paddingRight"),
            f = Xe(g, "paddingTop"),
            J = Xe(g, "paddingBottom"),
            k = new Ae(f,l,J,k)) : (k = Fe(g, "paddingLeft"),
            l = Fe(g, "paddingRight"),
            f = Fe(g, "paddingTop"),
            J = Fe(g, "paddingBottom"),
            k = new Ae(parseFloat(f),parseFloat(l),parseFloat(J),parseFloat(k))),
            F && !Fb(9) ? (l = Ze(g, "borderLeft"),
            f = Ze(g, "borderRight"),
            J = Ze(g, "borderTop"),
            g = Ze(g, "borderBottom"),
            g = new Ae(J,f,g,l)) : (l = Fe(g, "borderLeftWidth"),
            f = Fe(g, "borderRightWidth"),
            J = Fe(g, "borderTopWidth"),
            g = Fe(g, "borderBottomWidth"),
            g = new Ae(parseFloat(J),parseFloat(f),parseFloat(g),parseFloat(l))),
            e.pixelWidth = c.width - g.left - k.left - k.right - g.right,
            e.pixelHeight = c.height - g.top - k.top - k.bottom - g.bottom) : (e.pixelWidth = c.width,
            e.pixelHeight = c.height)));
            this.j && (g = parseFloat(this.a.style.left),
            c = parseFloat(this.a.style.top),
            D(!isNaN(g) && !isNaN(c), "Could not parse position."),
            isFinite(g) && 0 == g % 1 && isFinite(c) && 0 == c % 1 || Ie(this.a, Math.round(g), Math.round(c)))
        }
        eh(this, a, b, d)
    }
    ;
    var eh = function(a, b, c, d) {
        ...
        a.b ? (c = Oe(a.b, a.a),
        d = fh(a.b, b),
        ch(b) ? e.style.top = gh(c.y + d.y, a.a.offsetHeight - 15) + "px" : e.style.left = gh(c.x + d.x, a.a.offsetWidth - 15) + "px") : e.style[0 == c ? ch(b) ? "top" : "left" : ch(b) ? "bottom" : "right"] = d + "px"
    }
      , gh = function(a, b) {
    ...
    S.prototype.setEnabled = function(a) {
        this.b() != a && (S.m.setEnabled.call(this, a),
        ih(this))
    }
    ;
    ...
    var jh = function(a, b) {
        a.l() && (a = a.l(),
        b ? Mc(a, "jfk-button-clear-outline") : Oc(a, "jfk-button-clear-outline"))
    }
      , ih = function(a) {
        a.l() && kh(a.c, a)
    }
    ...
    var ph = function(a, b, c) {
        var d = c.toLowerCase();
        d in nh && oh[nh[d.toLowerCase()]] >= b.length ? (a.U && Sa(a.U, "no-audio") && (0 == a.U.length && (a.U = null),
        Hf(a, "no-audio", !1)),
        a.za = b,
        a.ya = c) : Sf(a, "no-audio")
    }
      , mh = function(a, b) {
...
*/
    ...
    sh.prototype.cancel = function(a) {
        if (this.a)
            this.c instanceof sh && this.c.cancel();
        else {
            if (this.b) {
                var b = this.b;
                delete this.b;
        ...
        for (var d = c = !1; a.i.length && !a.o; ) {
            ...
            if (f = a.h ? g : f)
                try {
                    ...
                    p(k) && (a.h = a.h && (k == b || a.isError(k)),
                    a.c = b = k);
                    if (Dg(b) || "function" === typeof n.Promise && b instanceof n.Promise)
                        d = !0,
                        a.o = !0
                } catch (l) {
                    b = l,
    ...
    var Ih = function(a, b) {
        ...
        e.onload = e.onreadystatechange = function() {
            e.readyState && "loaded" != e.readyState && "complete" != e.readyState || (Fh(e, c.Tb || !1, k),
            yh(g),
            zh(null),
            vh(g, !0, null))
        }
    ...
    Jh.prototype.send = function(a, b, c, d) {
        ...
        for (l in a)
            for (var g = w(a[l]) ? a[l] : [a[l]], k = 0; k < g.length; k++)
                null != g[k] && (e += f + encodeURIComponent(l) + "=" + encodeURIComponent(String(g[k])),
                f = "&");
        var l = ad(e);
        l = Ih(l, b);
    ...
    var Xh = function(a) {
        ...
        if (a.query)
            if (a.Ob) {
                ...
                b += '</select></div><div class="gtx-source-audio"><div class="jfk-button-img"></div></div><div class="gtx-body">' + gg(a.query) + '</div><br><div class="gtx-language">' + gg(a.hc) + '</div><div class="gtx-target-audio"><div class="jfk-button-img"></div></div><div class="gtx-body">' + gg(a.Ob) + "</div>";
                if (a.ub) {
                ...
                b += "No translation results for <b>" + gg(a.query) + "</b>.";
        return b
    };
    ...
    Yh.prototype.j = function() {
        ...
        for (var a in this.a)
            if (0 != this.a[a]) {
                ...
                b in this.a && (n.clearTimeout(this.a[b][0]),
                delete this.a[b])
            }
    }
    ;
    ...
    ti.prototype.send = function(a, b, c, d) {
        ...
        try {
            Ci(this),
            0 < this.o && (this.D = Di(this.a),
            mi(this.P, Ai(this, "Will abort after " + this.o + "ms if incomplete, xhr2 " + this.D)),
            this.D ? (this.a.timeout = this.o,
            this.a.ontimeout = z(this.qa, this)) : this.v = Vg(this.qa, this.o, this)),
            mi(this.P, Ai(this, "Sending request")),
            this.u = !0,
            this.a.send(a),
            this.u = !1
        } catch (f) {
            mi(this.P, Ai(this, "Send error: " + f.message)),
            Bi(this, f)
        }
    }
    ;
    ...
    ti.prototype.qa = function() {
        "undefined" != typeof aa && this.a && (this.j = "Timed out after " + this.o + "ms, aborting",
        this.h = 8,
    ...
    ti.prototype.abort = function(a) {
        this.a && this.b && (mi(this.P, Ai(this, "Aborting")),
        this.b = !1,
        this.c = !0,
        this.a.abort(),
        this.c = !1,
                ...
                try {
                    if (Ji(a))
                        ...
                        try {
                            ...
                            mi(a.P, "Can not get status: " + c.message),
                            b = ""
                        }
                        a.j = b + " [" + Ii(a) + "]";
                        Ei(a)
    ...
    Jj.prototype.a = function(a, b, c, d) {
        if (null != d) {
            for (var e = d.src, f = Rh(Vh), g = [], k = [], l = d.sentences, m = 0; m < l.length; m++)
                g.push(l[m].orig),
                k.push(l[m].trans);
            g = g.join("");
            k = k.join("");
            ...
            Vd(Id(document, "translation"), rh("MSG_TRANSLATION_ERROR"))
    }
    ;
    ...
    Lj.prototype.listen = function(a, b, c, d, e) {
        var f = function(a) {
            ...
            "click" == a.type && kc(a) ? c.call(d, a) : 13 != a.keyCode && 3 != a.keyCode || "keyup" == a.type ? 32 != a.keyCode || "keyup" != a.type || "button" != e && "tab" != e || (c.call(d, a),
    ...
    var Pj = function(a, b) {
      ...
      , Qj = function(a) {
                    ...
                    if (g instanceof Vc)
                        ...
                        if (!(g instanceof id)) {
                            ...
                            for (e in k) {
                                ...
                                var l = k[e];
                                null != l && (l = w(l) ? Ma(l, pd).join(" ") : pd(l),
                                g += e + ":" + l + ";")
                            }
                            g ? (e = g,
                            D(!/[<>]/.test(e), "Forbidden characters in style string: " + e),
                            g = jd(g)) : g = kd
                        }
                        g instanceof id && g.constructor === id && g.b === hd ? e = g.a : (Ba("expected object of type SafeStyle, got '" + g + "' of type " + u(g)),
        ...
        d = void 0;
        null != d ? w(d) || (d = [d]) : d = [];
        !0 === Tc.div ? (D(!d.length, "Void tag <div> does not allow content."),
        m += ">") : (c = yd(d),
        m += ">" + sd(c) + "</div>",
        c = c.ua());
    ...
    h.play = function() {
        ...
        this.b = 1;
        if (Qj())
            return De(this.a, this.j),
            this.h = Vg(this.bc, void 0, this),
            !0;
        this.mb(!1);
        return !1
    }
    ...
    var Yj = function(a) {
        ...
        b += '<div class="' + R("jfk-bubble-arrow-id") + " " + R("jfk-bubble-arrow") + '"><div class="' + R("jfk-bubble-arrowimplbefore") + '"></div><div class="' + R("jfk-bubble-arrowimplafter") + '"></div></div></div>';
        return fg(b)
    };
    ...
    var ak = function(a, b) {
        ...
        if (b && a)
            if (q(b))
                ...
                b instanceof rd ? Bd(a, b) : (Bd(a, zd),
                a.appendChild(b))
    };
    h = Zj.prototype;
    h.Ya = function() {
    ...
    var gk = function(a, b, c) {
      ...
      , lk = function(a, b, c) {
        if (a) {
            ...
            chrome.i18n.detectLanguage(d, function(d) {
                d.isReliable ? c(d.languages[0].language) : 0 < b ? lk(a.parentNode, b - 1, c) : c("")
            })
        } else
            c("")
    }
      ...
      , ik = function(a, b) {
        ...
        chrome.i18n.detectLanguage(c, function(c) {
            var d = null;
            if (c.isReliable)
                return d = c.languages[0].language,
                b(d);
    ...
    chrome.runtime.onMessage.addListener(function(a) {
        a["gtx.detected"] && (ck = a["gtx.detected"],
        kk(dk))
    });
    var Th = new Ph
      , ek = Jj.N();
    xc(window, "mouseup", function(a) {
        if (0 == a.button && !Id(document, "gtx-trans")) {
            ...
            Qh || "1" != Th.a || !Th.i || ck ? window.setTimeout(A(kk, a), 0) : (dk = a,
            chrome.runtime.sendMessage({
                detectLanguage: 1
            }))
        }
    ...
    xc(window, "mousedown", function(a) {
        ...
        b && (Ud(b, a.target) ? a.preventDefault() : (Gc(b),
        Td(b)));
    ...
    for (var qk; ok.length && (qk = ok.shift()); )
        !ok.length && p(nk) ? pk[qk] = nk : pk[qk] && pk[qk] !== Object.prototype[qk] ? pk = pk[qk] : pk = pk[qk] = {};
}
)();
