...
var evaluate_map = {
    ...
    ExpressionStatement: function (node, scope) {
        return evaluate(node.expression, scope);//qgb add return, caller: _evalute(node, scope, arg);
    },
...
//          var name_4=node.left.name ;
            ...
            $var = {//qgb add this
                name_4: node.left.name,
                $set: function (value) { 
                     scope.$let(this.name_4,value)
                    return value;
                },
                $get: function () {
                    return value;
